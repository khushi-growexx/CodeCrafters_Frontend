...
class GenerateControllerCodeScreen extends StatefulWidget {
  static const String name = "generate_controller_code_screen";
  static const String path = "/$name";
  const GenerateControllerCodeScreen({super.key});

  @override
  State<GenerateControllerCodeScreen> createState() => _GenerateControllerCodeScreenState();
}

class _GenerateControllerCodeScreenState extends State<GenerateControllerCodeScreen> {
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: TextButton.icon(
                          ...
                          onPressed: () {
                            viewModel?.getResponseFromChatGPT("${inputC.text}. Generate Controller Code for this.");
                          },

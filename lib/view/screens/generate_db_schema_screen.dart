...
class GenerateDbSchemaScreen extends StatefulWidget {
  static const String name = "generate_db_schema_screen";
  static const String path = "/$name";
  const GenerateDbSchemaScreen({super.key});

  @override
  State<GenerateDbSchemaScreen> createState() => _GenerateDbSchemaScreenState();
}

class _GenerateDbSchemaScreenState extends State<GenerateDbSchemaScreen> {
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: TextButton.icon(
                          ...
                          onPressed: () {
                            viewModel?.getResponseFromChatGPT("${inputC.text}. Generate Database schema for this. Also generate DDL, DML statements for each tables.");
                          },
